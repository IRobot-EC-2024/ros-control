...
class DjiMotorBase : public irobot_ec::hal::CanDeviceBase {
 public:
  DjiMotorBase() = delete;
 ...
 protected:
  ...
  void RxCallback(std::unique_ptr<struct can_frame> msg) override;
   ...
   */
  static std::array<std::unordered_map<hal::Can *, std::array<uint8_t, 18>> *, 3> tx_bufs_;
